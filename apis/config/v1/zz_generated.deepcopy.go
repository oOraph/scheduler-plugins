...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NodePressureArgs) DeepCopyInto(out *NodePressureArgs) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	if in.MinPressure != nil {
		in, out := &in.MinPressure, &out.MinPressure
		*out = new(int64)
		**out = **in
	}
	if in.MaxPressure != nil {
		in, out := &in.MaxPressure, &out.MaxPressure
		*out = new(int64)
		**out = **in
	}
	if in.NodeLabel != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NodePressureArgs.
func (in *NodePressureArgs) DeepCopy() *NodePressureArgs {
	if in == nil {
		return nil
	}
	out := new(NodePressureArgs)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *NodePressureArgs) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
